...
A brief note: The read.table command loads the CSV file provided by NCDC into a table structure in R, here called 'clim'; the as.Date command then transforms the DATE field in that table into an R-formatted date array that R knows how to do things with.
